...
#include <stdio.h>
//g++ ImageStitching.cpp -o image_stich -I /usr/include/opencv4 -lopencv_core -lopencv_videoio -lopencv_highgui -lopencv_imgcodecs -lopencv_features2d -pthread
...
int main()
{
    ...
    std::string image_path1 = "/home/ctnano/Desktop/Coding_Folder/Image-Stitching/Images/Hill1.jpg";
    std::string image_path2 = "/home/ctnano/Desktop/Coding_Folder/Image-Stitching/Images/Hill2.jpg";
    Mat image1 = imread(image_path1);
    Mat image2 = imread(image_path2);

    //printf("String 1 path : %s \r\n", image_path1.c_str());
    //printf("String 2 path : %s \r\n", image_path2.c_str());
